...
<c:set var="x" value="0"></c:set>
  ...
  <c:if test="${product.getCategory() == 'artmartiaux' }">
  ...
  <div class="card" style="background: Silver; margin-left:50px; margin-top:40px">
   ...
   <h5 style="color: white" class="card-title"><c:out value="${product.getName() }"></c:out></h5>
    ...
    <a class="btn btn-primary" href="Controller?page=addtocart&action=artmartiaux&id=<c:out value ="${product.getId() }"/>">Ajouter au panier</a>
